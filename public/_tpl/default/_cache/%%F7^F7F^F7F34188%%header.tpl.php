<?php /* Smarty version 2.6.26, created on 2014-03-03 06:32:50
...
" style="background:url(<?php echo $this->_tpl_vars['BASE_URL']; ?>
img.php?q=site_logo) no-repeat !important;"><?php echo $this->_tpl_vars['translations']['header']['name']; ?>
</a></h1>
			<ul id="top">
...
/img/ajax-loader.gif" alt="" /></span>
			...
			<div class="addJob">
				<a class="postJobBtn" href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
post/"><span><?php echo $this->_tpl_vars['translations']['search']['submit']; ?>
</span></a>
			</div><!-- .addJob -->
			<?php endif; ?>
		</div><!-- #box -->
