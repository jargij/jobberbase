...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'settings.tpl', 8, false),array('modifier', 'escape', 'settings.tpl', 52, false),)), $this); ?>
...
_tpl/img/pencil.png" alt="Edit" /></a>
					<h4 class="bold mb05"><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
settings/<?php echo $this->_tpl_vars['settings_categories'][$this->_sections['tmp']['index']]['var_name']; ?>
...
">
				<a class="right" href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
password/" title="Change password"><img src="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_tpl/img/pencil.png" alt="Edit" /></a>
				<h4 class="bold mb05"><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
password/">Change your password</a></h4>
...
?>								
		...
		<form id="publish_form" method="post" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
...
?>
				...
				<?php $this->assign('extradata', $this->_tpl_vars['setting']['extradata']); ?>
				
				<div class="row <?php echo smarty_function_cycle(array('values' => 'odd,even'), $this);?>
<?php if ($this->_tpl_vars['errors'][$this->_tpl_vars['name']] != ''): ?> error<?php endif; ?>">
					<table width="100%"><tr>
					<td width="180" valign="top"><strong><?php echo $this->_tpl_vars['title']; ?>
:</strong></td>
					<td>
...
<br />
						<?php endfor; endif; ?>
					<?php elseif ($this->_tpl_vars['input_type'] == 'file'): ?>
						Current logo:<br />
						<img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
img.php?q=<?php echo $this->_tpl_vars['name']; ?>
" alt="" /><br /><br />
