<?php /* Smarty version 2.6.26, created on 2014-03-03 06:25:40
...
_tpl/img/pencil.png" alt="edit" /></a>
...
_tpl/img/star_off.png" alt="activate" /></a>
			<?php else: ?>
...
_tpl/img/star_on.png" alt="deactivate" /></a>
			<?php endif; ?>&nbsp;
...
_tpl/img/switch_off.png" alt="activate" /></a>
			<?php else: ?>
...
_tpl/img/switch.png" alt="deactivate" /></a>
			<?php endif; ?>&nbsp;
...
" />
		<strong><a href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
...
"><?php echo $this->_tpl_vars['job']['title']; ?>
		...
		<span class="light">at</span> <?php echo $this->_tpl_vars['job']['company']; ?>
...
<?php endif; ?>
 ...
 times</strong><?php if ($this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]): ?>, <strong><?php echo $this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]['numberOfApplications']; ?>
 applicants</strong>, 
			last application on <strong><?php echo $this->_tpl_vars['statisticalData'][$this->_tpl_vars['job']['id']]['lastApplicationOn']; ?>
</strong><?php endif; ?><?php if ($this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]): ?>,
			<span class="spam"> reported as spam <strong><?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['numberOfSpamReports']; ?>
 times</strong>, 
				last time on <strong><?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['lastSpamReportOn']; ?>
